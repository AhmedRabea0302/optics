...
@section('content')
    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <h3 class="box-title">Customers <small
                    class="badge bg-green">{{$customers->count() ? $customers->total() : ''}}</small></h3>
                ...
                <div class="row" style="margin-top: 6px">
                    ...
                    <div class="col-md-4">
                        ...
                        @if(auth()->user()->hasPermission('create_users'))
                            <a href="{{route('dashboard.get-add-customer')}}" class="btn btn-primary  btn-flat"
                               style="color: #fff"><i class="fa fa-plus"></i> Add Customer</a>
                        @else
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($customers as $index => $customer)
                            <tr>
                                <th>{{$index + 1}}</th>
                                <td>
                                    <a href="{{route('dashboard.show-customer',['id' => $customer->id])}}">{{$customer->customer_id}}</a>
                                </td>
                                ...
                                <td>
                                    <div style="display: flex">
                                        ...
                                        @else
                                            <a href="#" class="btn btn-info btn-sm disabled  btn-flat"><i
                                        ...
                                        @else
                                            <button type="submit" class="btn btn-danger btn-sm disabled btn-flat delete"
                                                    style="margin-left: 10px"><i class="fa fa-trash-o"></i> Delete
                                            </button>
                                        @endif
                                    </div>
