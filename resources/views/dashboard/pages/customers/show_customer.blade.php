                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="title" id="title" class="form-control" id="title" readonly>
                                ...
                                <option value="Prince" {{ $customer->title == 'Prince' ? 'selected' : '' }}>Prince
                                </option>
                                <option value="Sheikh" {{ $customer->title == 'Sheikh' ? 'selected' : '' }}>Sheikh
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="prefered_language" id="prefered_language" class="form-control" readonly>
                                <option
                                    value="English" {{ $customer->prefered_language == 'English' ? 'selected' : '' }}>
                                    English
                                </option>
                                <option value="Arabic" {{ $customer->prefered_language == 'Arabic' ? 'selected' : '' }}>
                                    Arabic
                                </option>
                            </select>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="city" id="city" id="city" class="form-control" readonly>
                            ...
                            <option value="Al Ru'ays">Al Ru'ays</option>
                            <option value="Al Wakrah">Al Wakrah</option>
                            <option value="Ash Shahaniyah">Ash Shahaniyah</option>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="address" id="address" cols="30"
                                  rows="3" readonly>{!!  $customer->address !!}</textarea>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="receive_nots" id="receive_nots" class="form-control" readonly>
